...
export const Footer = () => {
    ...
    return (
        <div className="py-6 px-10 flex flex-col">
            ...
            <div className="absolute sm:right-20 left-3 h-14 w-14 bg-pink-500/20 rounded-full flex items-center justify-center translate-y-10 cursor-pointer select-none" onClick={() => setCount((prev)=>prev+1)}>
